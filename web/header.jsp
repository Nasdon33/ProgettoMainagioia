        ...
        <div class="row header">
            ...
            <div class="col-md-6 col-xs-8"> 
                ...
                <center>
                    ...
                    <input type="radio" id="r2" name="paramricerca" value="cucina"> Cucina
                    <input type="radio" id="r3" name="paramricerca" value="nome"> Nome
                    <input type="radio" id="r4" name="paramricerca" value="indirizzo"> Indirizzo
                    <input type="hidden" name="radioidord" value="gridRadios1" />
                    </p>
                </center>
