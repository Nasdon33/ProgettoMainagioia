       ...
       <div class="row">
        ...
        <center>
			...
			<div class="row">
				...
				<div class="col-xs-6 col-xs-offset-3 col-md-4 col-md-offset-4"><input type="submit" value="Inserisci" class="btn btn-primary btn-block btn-lg Azzurro" tabindex="7"></div>
                        </div>
		</form>
	</div>
    </div>      
